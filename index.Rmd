...
description: "Loodusteaduste ja matemaatika elulised õpilood"
lang: en
include-before:
    - \input{title-page.tex}
title: "`r if (knitr::is_latex_output()) { '' } else { 'Loodusteaduste ja matemaatika<br/>elulised õpilood' }`"
...
Matkan \num{2024}. a Lääne-Euroopas ja loon Eesti õppekavade õpiväljundite kohta lugu, mis kätkeb endas loodusteadusi ja matemaatikat.
